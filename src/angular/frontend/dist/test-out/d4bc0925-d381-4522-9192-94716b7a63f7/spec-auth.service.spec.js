import {
  ...
  init_auth_service,
  init_router
} from "./chunk-6TNNF5GR.js";
import {
  ApiService,
  init_api_service
} from "./chunk-YIQRTKI3.js";
import "./chunk-FASDTLXK.js";
import {
  TestBed,
  firstValueFrom,
  init_esm,
  ...
  "src/app/core/services/auth.service.spec.ts"(exports) {
    ...
    describe("AuthService", () => {
      ...
      it("persiste token e emite usu\xE1rio quando login retorna perfil", () => __async(null, null, function* () {
        ...
        const emitted = yield firstValueFrom(service.user$.pipe(skip(1)));
      ...
      it("atualiza perfil preservando e-mail armazenado", () => __async(null, null, function* () {
        ...
        expect(updated.email).toBe("ana@empresa.com");
        const latest = yield firstValueFrom(service.user$.pipe(skip(1)));
